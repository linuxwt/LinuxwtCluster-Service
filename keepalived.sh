...
if [ $ip == "192.168.0.169" ];then
    sed -i 's/192.168.0.168/192.168.0.169/g' /etc/keepalived/keepalived.conf
    ...
    sed -i 's/192.168.0.168/192.168.0.170/g' /etc/keepalived/keepalived.conf
